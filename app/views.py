...
class ProductView(View):
    def get(self, request):
        ...
        return render(request, 'app/home.html',
         {'topweare':topweare, 'bottomweare':bottomweare, 'laptop':laptop, 'mobile':mobile  })
...
def topweare(request, data=None):
    topdress = Product.objects.filter(category = 'TW')
    return render(request, 'app/topdress.html',{'topdress':topdress})

def bottomweare(request, data=None):
    bottomdress = Product.objects.filter(category = 'BW')
    return render(request, 'app/bottomdress.html',{'bottomdress':bottomdress})
...
def checkout(request):
    ...
    return render(request, 'app/checkout.html',{'add':add, 'cart_items':cart_items, 'total_amt':total_amt })
